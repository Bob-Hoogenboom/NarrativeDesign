...
#characters
define h = Character("Hartley")
define s = Character("Soldier")
define p = Character("Private")
define f = Character("F.V7")
define ef = Character("Fox")


define trans = Fade(0.5, 1.0, 0.5)

init:
    $ flash = Fade(0.25, 0.0, 0.25, color = "#fff")
    $ scan = Fade(0.5, 0.25, 0.5, color = "#ff0000")
    $ blackOut = Fade(0.5, 0.0, 0.5, color = "#000000")

    $ fv7IsWounded = False
    $ isBearObserved = False
